...
function Not()
   ...
   Title = "MONA / COMMUNITY"; -- the title (ofc)
   Text = "เลือกอาวุธสิไอ้ควาย"; -- what the text says (ofc)
...
function Fot()
   game.StarterGui:SetCore("SendNotification", {
   Title = "MONA / COMMUNITY"; -- the title (ofc)
   Text = "เลือกผลปีศาจสิไอ้ควาย"; -- what the text says (ofc)
   Icon = "rbxassetid://57254792"; -- the image if u want. 
   Duration = 2; -- how long the notification should in secounds 
   })
end
function Sec()
   game.StarterGui:SetCore("SendNotification", {
   Title = "MONA / COMMUNITY"; -- the title (ofc)
   Text = "โค้ดควายๆสำหรับมึง"; -- what the text says (ofc)
...
function Wea()
   game.StarterGui:SetCore("SendNotification", {
   Title = "MONA / COMMUNITY"; -- the title (ofc)
   Text = "อาวุธกังของมึงสำเร็จละ"; -- what the text says (ofc)
   Icon = ""; -- the image if u want. 
   Duration = 2; -- how long the notification should in secounds
   })
end
function Fse()
   game.StarterGui:SetCore("SendNotification", {
   Title = "MONA / COMMUNITY"; -- the title (ofc)
   Text = "เลือกผลกังๆของมึงสำเร็จ"; -- what the text says (ofc)
   Icon = ""; -- the image if u want. 
...
function Next()
   game.StarterGui:SetCore("SendNotification", {
   Title = "MONA / COMMUNITY"; -- the title (ofc)
   Text = "yedheemaymung"; -- what the text says (ofc)
   Icon = ""; -- the image if u want. 
   Duration = 2; -- how long the notification should in secounds
   })
end
...
-----------------------------------------
----------------------------------------- Gui Go
  local Window = create:Win("MONA / COMMUNITY    |   SHIROKO SO CUTE")
  ...
  function TPSever()
   game.StarterGui:SetCore("SendNotification", {
   Title = "MONA / COMMUNITY"; -- the title (ofc)
   Text = "คนจะมาทำควยไรเยอะแยะย้ายเซิฟไวๆดิ้"; -- what the text says (ofc)
   Icon = "rbxassetid://57254792"; -- the image if u want. 
